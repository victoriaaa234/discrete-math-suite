# feature/PremiseTextBoxInput.feature

Feature: User can input text into Premise text box
  
Scenario: Input text into Premise text box
  Given I am on the Discrete Math Suite Logic page
  When I input text into premise text box
  Then I expect for the text I inputted to appear in the corresponding text box
